...
params.threads = 6
params.reference        = "$projectDir/reference/fastaseq_AmpSeq_ASAAP_Fragments_v2.fasta"
params.bedfile				 = "$projectDir/reference/amplicon_len.bed"
...
// run the pipeline
  ...
  // non_covered_regions(mapping_ampseq.out.bam, variant_calling_ampseq.out)
